...
documentation review and update
      ↓
ready-for-review pull request or no change
      ↓
...
Track reads the exact source revision and the current documentation, prepares
the customer-facing updates it finds necessary, and checks the proposed
result. Your team can follow the run through preparation, writing, validation,
and pull request creation. If no documentation change is needed, Track finishes
without opening a pull request.

When Track does propose an update, it opens a normal ready-for-review pull
request in the primary documentation repository. Your team can correct, merge,
or close it. Track never merges the proposal itself.
