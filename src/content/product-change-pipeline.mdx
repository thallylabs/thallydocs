...
<Steps>
  ...
  <Step title="Track updates each allowed destination">
    ...
    pull request for the primary documentation repository. When Knowledge
    surfaces are connected, it can also prepare draft pull requests in those
    Markdown or MDX repositories. If nothing is affected, the loop stops
