...
| `horizontal` | `boolean` | `false` | Uses a horizontal layout instead of stacking the icon above the title |
| `cta` | `string` | — | Explicit action label |
| `arrow` | `boolean` | `false` | Shows a directional arrow in the top-right corner |
| `type` | `info \| success \| warning \| danger \| note \| tip \| check` | — | Intent-aware surface treatment |
