...
<Steps>
  ...
  <Step title="Choose Knowledge surfaces">
    If this step is available, add Markdown or MDX repositories that contribute
    to Product Knowledge. These connections are separate from Track, which opens
    review pull requests only in the site's primary documentation repository.
    You can manage them later from **Site settings → Knowledge surfaces**.
  </Step>
...
| **Track**            | Connect Product sources, choose pull request, merge, or scheduled triggers, and follow each run to a reviewable pull request or no-change result.                                 |
