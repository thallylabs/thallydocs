...
Cloud AI workflows, including managed translation and Track, use this workspace
balance rather than a separate allowance for each site or repository. You do
not need to supply a model-provider API key to Thally Cloud. Check your
workspace's AI Credit balance before running Track or generating translations.
Credits and feature access are separate: a remaining balance does not keep
paid features unlocked after the trial expires.
