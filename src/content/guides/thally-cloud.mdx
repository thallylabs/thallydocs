...
balance rather than a separate allowance for each site or repository.
Customer-supplied model-provider API keys are not part of Thally Cloud's public
offering. Check your workspace's AI Credit balance before running Track or
