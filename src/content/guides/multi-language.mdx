...
<Card title="AI-powered translation" icon="wrench">
  Thally Cloud generates translations when you save languages. Self-hosted
  sites can translate with one command. Code and MDX structure are validated.
</Card>
...
readers should see, and save. Confirm that Thally may use your site's Anthropic
key or your workspace's AI Credits. You can leave the page while Thally
