...
environment with your Anthropic key. Cloud Track uses the same reviewed-output
contract but runs behind Thally's isolated managed worker. See
[Thally Track](/guides/thally-track) before choosing the operating model.
