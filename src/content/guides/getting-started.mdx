...
navTitle: CLI setup
description: Use the developer setup path for local evaluation, automation, migration, or a self-hosted documentation site.
---
...
```bash
npx --yes @thallylabs/cli@latest migrate https://github.com/acme/docs acme-docs
```

You can also migrate a public documentation URL:

```bash
npx --yes @thallylabs/cli@latest migrate https://docs.acme.com acme-docs
```
...
```bash
npx --yes @thallylabs/cli@latest migrate https://github.com/acme/docs acme-docs --platform mintlify --yes
```
...
`npx --yes @thallylabs/cli@latest check`. Imported content remains yours to edit and reorganize.
</Note>
