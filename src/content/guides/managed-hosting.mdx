...
is available, **Settings → Version** shows the current and target release.
Review the upgrade, then apply it to update framework-owned files and publish
the result. Your pages and other authored files stay under Git review.
...
The first command is a dry run. The second applies the reviewed plan.
